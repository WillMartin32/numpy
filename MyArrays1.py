...
# create a 2 dimentional array of 5 interger elements each using the random module
...
num01 += 10 # Will change original array

num04 = num01 * num02 # Have to be same size

num05 = num01 > 13 # Returns if it is T/F
...
#calculate average on all columns on each row
